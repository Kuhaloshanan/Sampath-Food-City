...
public class Annual_sales extends javax.swing.JFrame {
    ...
    private void btn_checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_checkActionPerformed
        ...
        annual.Annual(year_fld, annual_sales_txtfld, jTable1);
    ...
    public void Annual(JTextField yearField, JTextField annualSalesField, JTable table) {
        ...
        try {
            ...
            String query = "SELECT product_name, SUM(quantity) AS total_quantity, price_per_unit, "
                    ...
                    + "FROM items WHERE YEAR(date) = ? GROUP BY product_name, price_per_unit";
            ...
            // Set the overall total sales in the text field
