...
public class Branch_performance extends javax.swing.JFrame {
    ...
    private void btn_checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_checkActionPerformed
        String branchName = enter_region_txtf.getText(); // Get the branch name from the text field
        JTable table = jTable1; // Reference to your table
        javax.swing.JTextField totalAmountField = total_amount_txtf; // Reference to the total amount field
    ...
    public void branch(String branchName, JTable table, javax.swing.JTextField totalAmountField) {
        ...
        try {
            ...
            String query = "SELECT product_name, customer_id, quantity, price_per_unit FROM items WHERE region = ?";
