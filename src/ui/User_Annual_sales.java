 ...
 * @author rkuha
 */
public class User_Annual_sales extends javax.swing.JFrame {

    /**
     * Creates new form product_performance
     */
    public User_Annual_sales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        annual_sales_txtfld = new javax.swing.JTextField();
        ...
        jPanel1.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 270, 80, -1));
        ...
        jPanel1.add(btn_check, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 230, 80, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 350, 760, 410));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel7.setText("You are in Annual Sales Report");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 80, -1, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Sales Amount");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 270, -1, 20));
        ...
        jPanel1.add(annual_sales_txtfld, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 270, 180, -1));
        jPanel1.add(year_fld, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 230, 180, -1));
    ...
    private void btn_checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_checkActionPerformed
        ...
        annual.annualsalescheck(year_fld, jTable1);
    ...
    private void btn_annualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_annualActionPerformed
        // TODO add your handling code here:
        User_Annual_sales an = new User_Annual_sales();
        this.dispose();
        an.setVisible(true);
    ...
    public class annuasales extends Annual_sales {
        ...
        public void annualsalescheck(JTextField year_fld, JTable jTable1) {
            super.Annual(year_fld, annual_sales_txtfld, jTable1);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Annual_sales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User_Annual_sales().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField annual_sales_txtfld;
