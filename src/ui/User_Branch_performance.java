 ...
 * @author rkuha
 */
public class User_Branch_performance extends javax.swing.JFrame {

    /**
     * Creates new form product_performance
     */
    public User_Branch_performance() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        total_amount_txtf = new javax.swing.JTextField();
        enter_region_txtf = new javax.swing.JTextField();
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 190, -1, -1));

        jLabel3.setText("Enter Region");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 140, -1, -1));
        jPanel1.add(total_amount_txtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 180, -1));
        jPanel1.add(enter_region_txtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 140, 180, -1));
    ...
    private void btn_checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_checkActionPerformed
        ...
        String regionInput = enter_region_txtf.getText().trim();  // Extract text from JTextField
        performanceAnalyzer.branch(regionInput, jTable1, total_amount_txtf);
    ...
    public class BranchSalesPerformance extends Branch_performance {
        ...
        public void BranchPerformanceAnalysis(String enter_region_txtf, JTable jTable1, JTextField total_amount_txtf) {
            super.branch(enter_region_txtf, jTable1, total_amount_txtf);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Branch_performance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User_Branch_performance().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField enter_region_txtf;
    ...
    private javax.swing.JTextField total_amount_txtf;
